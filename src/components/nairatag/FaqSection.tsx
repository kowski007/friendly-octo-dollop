...
const items: FaqItem[] = [
  {
    ...
    body: (
      <>
        ...
        name like ₦victor that resolves to a clear recipient preview (name +
        bank), so users can confirm who they are paying before sending money.
      </>
    ),
    tone: "blue",
  },
  ...
  },
  {
    ...
    body: (
      <>
        ...
        clear badges (Verified and Business) where it matters: right before a
        payment is sent.
      </>
    ),
    tone: "orange",
  },
  {
    ...
    body: (
      <>
        ...
        and underscores, typically 2–20 characters. Examples: ₦mama_ijebu,
        ₦mikki, ₦fioso.
      </>
    ),
    tone: "gray",
