...
export const brunch24SamplePrompts = [
  "Find 3 dinner spots in Lekki",
  ...
  "Plan my evening in Lekki for 2 people with a budget of 30000",
...
export const foodVendors: FoodVendor[] = [
  {
    ...
    shortDescription:
      "Bright all-day dining spot for brunch, coffee, and casual dinner plans.",
  },
  {
    ...
    trustNote: "Seed listing for Brunch24 demo. Manual confirmation required.",
    shortDescription:
      "Popular for suya platters, pepper soup, and after-work group bookings.",
  },
  {
    ...
    trustNote: "Seed listing for Brunch24 demo. Manual confirmation required.",
    shortDescription:
      "Comfort-food kitchen with rice bowls, soups, and family-size trays.",
  },
  {
    ...
    trustNote: "Seed listing for Brunch24 demo. Manual confirmation required.",
    shortDescription:
      "Date-night friendly restaurant with outdoor seating and live acoustic sets.",
  },
];
...
export const hotels: HotelListing[] = [
  {
    ...
    shortDescription:
      "Modern boutique hotel close to restaurants and nightlife in Lekki.",
  },
  {
    ...
    shortDescription:
      "Upscale hotel for short city stays, client visits, and weekend getaways.",
  },
  {
    ...
    shortDescription:
      "Comfortable midrange hotel with breakfast and meeting-room options.",
  },
];
...
export const events: EventListing[] = [
  {
    ...
    shortDescription:
      "Daytime social with DJs, small plates, and networking-friendly seating.",
  },
  {
    ...
    shortDescription:
      "Live music, cocktails, and a relaxed after-work crowd by the waterfront.",
  },
  {
    ...
    ticketPriceNgn: 0,
    shortDescription:
      "Family-friendly food market with tasting stands and local vendors.",
  },
];
